...
class SaveVisitor(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('name', 'department', 'gender', 'contact', 'email', 'address', 'reason', 'status',)
    ...
    def save(self, commit=True):
        ...
        # Add the current date and time to the 'date_checkout' field
        instance.date_checkout = timezone.now()  # Make sure to import timezone from django.utils
